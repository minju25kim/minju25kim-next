...
export const PlateEditorMarkdown = ({ markdown, data, category, slug: oldSlug }: { markdown: string, data: any, category: string, slug: string }) => {
    const router = useRouter();
    const [title, setTitle] = useState(data.title || '');
    const [published, setPublished] = useState(!!data.published);
    const [slug, setSlug] = useState(oldSlug || '');
    const [editorValue, setEditorValue] = useState<string>(markdown);
