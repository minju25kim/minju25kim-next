...
export default async function VideoPage() {
  ...
  const allVideos = (files || []).map((file) => {
    ...
    return {
      ...
      isShort: file.name.toLowerCase().includes('short') || file.name.toLowerCase().includes('shorts'),
    };
  });
    ...
    <div className="min-h-screen p-8 bg-white dark:bg-gray-900 transition-colors duration-200">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-12">
          <h1 className="text-4xl font-bold text-gray-800 dark:text-gray-200">Content</h1>
        </div>
